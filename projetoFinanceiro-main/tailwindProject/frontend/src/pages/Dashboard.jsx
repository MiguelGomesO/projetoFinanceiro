...
export default function Dashboard({ usuarioID }) {
    ...
    return (
        <div className="space-y-8">
            ...
            <Card className="shadow-lg rounded-lg flex flex-col h-[400px] transition bg-linear-to-br from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900 font-serif">
